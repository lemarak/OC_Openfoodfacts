...
-- -----------------------------------------------------
-- Schema oc_openfoodfacts
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema oc_openfoodfacts
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `oc_openfoodfacts` DEFAULT CHARACTER SET utf8 ;
USE `oc_openfoodfacts` ;
...
INSERT INTO `oc_openfoodfacts`.`users` (`user_name`, `password`) VALUES ('default', '$2y$10$5DPrEjy91we1aWMkThfx/OfjgUu9t29ctezQ93dJraQ4HlTZvv5im');
